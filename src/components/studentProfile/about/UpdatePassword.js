...
import { updateStudentPassword } from './mutations'
import { graphql } from 'react-apollo'
import Alert from '../../Alert'

function UpdatePassword({ setIsChangePass, mutate }) {
    ...
    <div className="my-5">
      <form onSubmit={onSubmitHandler}>
        ...
        <div className="d-flex justify-content-end mt-5">
          <button onClick={e => setIsChangePass(false)} type="button" className="btn btn-sm btn-secondary mx-2">cancel</button>
...
export default graphql(updateStudentPassword)(UpdatePassword)
